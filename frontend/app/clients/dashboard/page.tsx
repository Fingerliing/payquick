  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col items-center py-12 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
        <Link href="/clients/scan" className="bg-white border rounded-xl p-6 shadow hover:shadow-lg transition">
        ...
        <Link href="/clients/order" className="bg-white border rounded-xl p-6 shadow hover:shadow-lg transition">
